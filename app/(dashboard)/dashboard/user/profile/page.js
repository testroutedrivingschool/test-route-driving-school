                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleProfileChange}
                          disabled
                          className="w-full px-3 py-2 border border-border-color rounded-md bg-gray-50 text-gray-500"
                        />
                      </div>
                    </div>
                        ...
                        <div className="space-y-4">
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full px-3 py-2 border border-border-color rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                              required
                            />
                            <button
                              type="button"
