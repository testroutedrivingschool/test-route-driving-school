...
export async function GET(req) {
  try {
    ...
    console.error("GET /api/sales/web error:", err);
    return NextResponse.json(
      { error: "Failed to fetch web sales" },
      { status: 500 }
    );
  }
}
