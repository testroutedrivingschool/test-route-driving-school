      ...
      <Container>
        <div>
          ...
          <div className="mb-8 flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold ">Test Route Driving School</h1>
            ...
            selectedInstructor && (
              <div className="grid grid-cols-1 md:grid-cols-9 gap-6">
                ...
                <div className="md:col-span-6 ">
                  ...
                  <div className="overflow-hidden mb-8 bg-white rounded-xl shadow-sm border border-border-color p-6">
                    ...
                    <div className="relative">
                      ...
                      <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1 shrink-0">
                          <div
                            className={`flex flex-col items-center cursor-pointer p-4 rounded-xl border-2 transition-all duration-200 min-w-[150px] h-full border-primary bg-primary/10 shadow-md`}
                          >
                        ...
                        <div className="overflow-hidden relative">
                              ...
                              .map((instructor) => (
                                <SwiperSlide key={instructor._id}>
                                  <div
                                    ...
                                    className="flex flex-col items-center cursor-pointer p-4 rounded-xl border-2 transition-all duration-200 min-w-[140px] hover:border-primary/20 hover:shadow-sm border-border-color"
                                  >
                          ...
                          {/* Custom styling for responsive navigation buttons */}
                          <button
                            onClick={() => swiperRef.current?.slidePrev()}
                            className="absolute left-0 top-1/2 transform -translate-y-1/2 z-20 bg-white p-2 rounded-full shadow-md flex items-center justify-center"
                          >
                            <FaChevronLeft className="text-primary w-4 h-4 md:w-5 md:h-5" />
                          </button>
                          <button
                            onClick={() => swiperRef.current?.slideNext()}
                            className="absolute right-0 top-1/2 transform -translate-y-1/2 z-20 bg-white p-2 rounded-full shadow-md flex items-center justify-center"
                          >
          ...
          <div className="mt-8 text-center text-sm text-gray-500">
            ...
            <p className="mt-2">
              Need help? Contact us at testroutedrivingschool@gmail.com or call
              +61 412 018 593
            </p>
          </div>
        </div>
