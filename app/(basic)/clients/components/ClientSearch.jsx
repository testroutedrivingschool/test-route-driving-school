...
export default function ClientSearch({setActiveTab, setSelectedClient}) {
  ...
  if (filters.clientNote?.trim()) params.set("clientNote", filters.clientNote.trim());
      ...
      <div className="flex-1">
        ...
        <form onSubmit={onSearch} className="space-y-2">
          ...
          <div className="pt-4 flex justify-end">
            <PrimaryBtn type={`submit`} className="px-6! py-3! text-xl!" disabled={isFetching}>
...
>
                      ...
                      <td className="px-3 py-2 font-semibold">
                        ...
                        {form.showClientNote && c.clientNote ? (
                          <div className="text-xs text-gray-500 mt-1">{c.clientNote}</div>
                        ) : null}
                      </td>
