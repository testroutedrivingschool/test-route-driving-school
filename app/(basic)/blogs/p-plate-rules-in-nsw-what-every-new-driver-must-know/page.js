...
const toc = [
  ...
  { id: "red-plates-restrictions", label: "Red P-Plates: The P1 Licence Restrictions" },
  { id: "green-plates-restrictions", label: "Green P-Plates: Moving to P2 Licence Restrictions" },
  { id: "mobile-phone-ban", label: "Mobile Phones and Technology: A Total Ban" },
  { id: "vehicle-restrictions", label: "Vehicle Restrictions and Alcohol Limits" },
  { id: "what-cars-can-p-platers-drive", label: "What Cars Can P-Platers Drive?" },
  { id: "professional-vs-trial", label: "Professional Training vs. Trial and Error" },
    ...
    <section>
      <PageHeroSection
        ...
        subtitle={
          <>
            Mastering{" "}
            <Link href="/services/driving-test-assessment" className="location-link">
              P-Plate Rules
            </Link>{" "}
            is the final hurdle to keeping your freedom on the road. In NSW,
            provisional drivers face strict restrictions on speed, passengers, and
            technology to ensure safety. This guide breaks down red and green
            P-plate laws, alcohol limits, and mobile phone bans. Stay informed to
            protect your license and avoid heavy fines while driving throughout
            Sydney and beyond.
          </>
        }
      />
            ...
            <article className="lg:col-span-8">
              <div className="rounded-2xl bg-white shadow-lg border border-border-color px-4 md:px-6 py-6 md:py-8">
                <div className="space-y-10 text-neutral leading-8">
                  ...
                  <section id="navigating-complex-rules" className="scroll-mt-24">
                    ...
                    <p className="mt-3 text-sm md:text-base leading-7">
                      ...
                      learner to the P-Plate Rules is exciting. However, the <strong>
                              P1
                              licence rules in NSW
                      </strong> are designed to be strict for a
                      reason. Statistics show that the first six months of solo
                      driving are the riskiest. <br/> <br/>In my 10 years of experience, the
                      biggest shock for new drivers is the complexity. You aren't
                      just driving; you are managing a list of "don'ts." From
                      speed limits for P-platers in NSW to strict mobile phone
                      bans, the law expects total compliance. One small mistake
                      can lead to an immediate three-month suspension. <strong>
                              Transport
                              for NSW
                      </strong> has even tightened rules in early 2026 regarding
                      overseas license conversions, showing their focus on higher
                      road standards.
                    </p>
                  </section>

                  {/* Red P-Plates: The P1 Licence Restrictions */}
                  <section id="red-plates-restrictions" className="scroll-mt-24">
                    <h2 className="text-2xl md:text-3xl font-bold text-secondary">
                      Red P-Plates: The P1 Licence Restrictions
                    </h2>
                    ...
                    <p className="mt-3 text-sm md:text-base leading-7">
                      ...
                      red <strong>P-Plate Rules</strong> are the most restrictive. You must hold
                      this license for at least 12 months. If you are under 25,
                      you face even tougher conditions during late-night hours.
                    </p>
                  ...
                  <section id="green-plates-restrictions" className="scroll-mt-24">
                    <h2 className="text-2xl md:text-3xl font-bold text-secondary">
                      Green P-Plates: Moving to P2 Licence Restrictions
                    </h2>
                    ...
                    <p className="mt-3 text-sm md:text-base leading-7">
                      ...
                      green Ps. The <Link href={`https://www.qld.gov.au/transport/licensing/driver-licensing/applying/provisional/p2`} className="location-link" target="_blank">P2 licence restrictions </Link>offer a bit more
                      freedom. Your speed limit for P-platers in NSW increases to
                      100 km/h. You also have 7 demerit points to work with.
                      However, many green P-Plate Rules stay the same. You still
                      cannot supervise a learner. You still cannot have any
                      alcohol in your system. I always tell my students that
                      green Ps are not a "free pass." Transport for NSW still
                      monitors your driving habits very closely. If you receive a
                      suspension on your P2 license, the time you are suspended
                      does not count toward your 24-month requirement for a full
                      license.
                    </p>
                  </section>
                  ...
                  <section id="mobile-phone-ban" className="scroll-mt-24">
                    ...
                    <p className="mt-3 text-sm md:text-base leading-7">
                      A common question I get is: Can P-plate drivers use a phone
                      for GPS in NSW? The answer is a firm No. Even in 2026,
                      Transport for NSW maintains a total ban. You cannot use
                      your phone for music, calls, or navigation. <br/>This includes
                      hands-free, Bluetooth, or even having the phone in a cradle.
                      If you need maps, you must use a dedicated GPS unit that is
                      not a phone. I once had a student lose their license because
                      they touched their phone to skip a song at a red light.
                    </p>
                    <div className="mt-5 rounded-2xl border border-border-color bg-base-300 p-6">
                      <ul className="space-y-2 text-sm md:text-base leading-7">
                        <li className="flex gap-2">
                          <FaCheckCircle className="mt-1 shrink-0" />
                          <span>
                            <strong>Important 2026 Update:</strong> This ban also
                            applies to Apple CarPlay and Android Auto. You cannot
                            have your phone connected to your car's screen via a
                            cable or Bluetooth if you are a P1 or P2 driver. Using
                            these systems counts as illegal mobile phone use.
                          </span>
                        </li>
                      </ul>
                    </div>
                  ...
                  <section id="vehicle-restrictions" className="scroll-mt-24">
                    ...
                    <p className="mt-3 text-sm md:text-base leading-7">
                      ...
                      in your system longer than you think. If you had a big night,
                      you might still be over the limit the next morning. Police
                      in areas like Kogarah and Sydney’s South frequently run
                      morning breath tests for this reason.
                    </p>
                  </section>

                  {/* What Cars Can P-Platers Drive? */}
                  <section id="what-cars-can-p-platers-drive" className="scroll-mt-24">
                    <h2 className="text-2xl md:text-3xl font-bold text-secondary">
                      What Cars Can P-Platers Drive?
                    </h2>

                    <p className="mt-3 text-sm md:text-base leading-7">
                      You might wonder, <strong>what cars can P-platers drive?</strong> You are
                      banned from high-performance vehicles. This usually means
                      cars with a power-to-weight ratio over 130kW per tonne. This
                      includes many turbocharged, supercharged, or V8 engines.
                      Always check the Transport for NSW prohibited vehicle list
                      before buying. Driving a banned car is an instant fine and
                      loss of points.
                    </p>
                  </section>
                  ...
                  <section id="professional-vs-trial" className="scroll-mt-24">
                    ...
                    <p className="mt-3 text-sm md:text-base leading-7">
                      ...
                      structured training is the best prevention. At <Link href={`/`} className="location-link">Test Route
                      Driving School,</Link> we teach more than just how to steer. We
                      teach the law. I’ve met many parents who were shocked to
                      learn that their child’s phone cradle was actually illegal
                      for a P-plater. By taking lessons with a professional, you
                      learn these nuances before you hit the road alone. This saves
                      you money in fines and protects your driving record from
                      the very start.
                    </p>
                  </section>
              ...
              <div className="lg:sticky lg:top-24 space-y-6">
                ...
                <div className="rounded-2xl border border-border-color bg-white shadow-sm p-5">
                  ...
                  <p className="mt-2 text-sm leading-7 text-neutral">
                    Understanding <Link href={`https://en.wikipedia.org/wiki/Driver%27s_licences_in_Australia`} className="location-link" target="_blank">P-Plate Rules</Link> is just the beginning of your
                    driving life. At Test Route Driving School, we don't just
                    help you pass the test; we prepare you for life as a solo
                    driver. We specialise in the Kogarah area and across Sydney.
                    Our expert instructors teach you the defensive habits that
                    keep your license safe. Don&apos;t let a simple rule mistake
                    cost you your freedom. Let&apos;s build your confidence and
                    knowledge together.
                  </p>
