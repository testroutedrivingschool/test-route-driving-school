...
const faqs = [
  {
    question:
      "How long does it take to complete driving lessons in Sydney suburbs?",
    answer: (
      <>
        Progress depends on your experience and practice frequency. Most
        learners improve within structured weekly sessions. Instructors track
        skills and adjust lesson plans.
      </>
    ),
  },
  {
    question:
      "Are automatic driving lessons better for beginners in Sydney suburbs?",
    answer: (
      <>
        Automatic cars reduce control complexity. Learners focus more on traffic
        and hazard awareness. Confidence develops faster without clutch
        management.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Lessons include common test routes and exam locations. Mock tests
        simulate real driving conditions. Mistakes are corrected before the test
        day.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Training plans remain flexible throughout your course. Instructors
        modify lessons after each assessment. Weak areas receive extra
        attention.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Training covers parking, lane control, and intersections. Highway
        driving and school zones are included. Defensive driving techniques
        improve road safety.
      </>
    ),
  },
];
export default function AutomaticDrivingLessonClient() {
    ...
    <div className="">
      <PageHeroSection
        ...
        subtitle={
          <>
            ...
            You deserve a stress-free experience while learning to handle modern
            traffic safely. We offer top-tier{" "}
      ...
      <section className="py-16 bg-base-300">
        <Container>
          <SectionHeader
            className={`mt-0!`}
            title={"Affordable Driving Lessons Sydney suburbs Packages"}
            subtitle={
              <>
                ...
                <strong>
                  {" "}
                  affordable driving lessons that Sydney suburbs{" "}
                </strong>{" "}
                learners can afford without compromising on quality or safety.
                Whether you need a single refresher or a complete beginner
                course, we have you covered. Explore our{" "}
                <Link
                  href={`/packages`}
                ...
                to find the best fit for you. You will save money while
                receiving the
                <strong>best driving lessons in Sydney suburbs </strong> from
          ...
          <div className="mt-10 flex flex-wrap gap-4 shrink-0">
            {automaticDrivingPackages.map((pkg,index) => {
              ...
              return (
                ...
                >
                  ...
                  <PrimaryBtn
                    ...
                    className={`w-full! mt-4 text-center! block!`}
                  >
                    {pkg.buttonText}
                  </PrimaryBtn>
                </div>
      ...
      <DrivingTipsSection
        subtitle={
          <>
            ...
            can be challenging, but having the right mindset makes it easier.
            Our experts offer these tips to help you succeed on NSW roads:
          </>
        }
