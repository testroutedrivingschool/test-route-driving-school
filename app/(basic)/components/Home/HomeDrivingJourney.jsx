      ...
      <Container>
        <div className="flex flex-col md:flex-row items-center gap-12 relative z-10">
          ...
          <div className="w-full md:w-1/2 relative">
            ...
            <div
              className={`relative bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl p-8 lg:p-12 shadow-2xl transition-all duration-700 ${
            ...
            >
              ...
              <div className="mt-8 space-y-2">
                ...
                <div className="h-2 bg-white/20 rounded-full overflow-hidden">
                  <div
                    className={`h-full bg-linear-to-r from-green-500 to-primary rounded-full transition-all duration-1000 ${
                      isVisible ? "w-3/4" : "w-0"
                    }`}
                  ></div>
                </div>
